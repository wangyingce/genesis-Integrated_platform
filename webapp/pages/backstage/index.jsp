...
<script type="text/javascript">	
 $(function(){
	 //alert(document.getElementById("index_user-info").innerHTML);
	 $.ajax({
         type: "get",     
         url: "/login/initIndex.do",    
         data: {}, 
            dataType: "json",
...
$('.change_Password').on('click', function(){
  ...
  $('#Exit_system').on('click', function(){
	...
	function(){
    	 $.ajax({
             type: "get",     
             url: "/login/exitSys.do",    
             data: {}, 
                dataType: "json",
                success: function(data) {
                     if(data=="0"){
                       layer.alert('系统异常',{title: '提示框',icon:1,});
                     }else if(data=="1"){
			...
			<div class="navbar-container" id="navbar-container">
               ...
               <ul class="nav ace-nav">	
				...
				<a data-toggle="dropdown" href="#" class="dropdown-toggle">
				 <span  class="time"><em id="time"></em></span><span class="user-info"><small>欢迎光临,</small><span  id="index_user-info"></span></span>
	           ...
	           <li class="purple">
				<a data-toggle="dropdown" class="dropdown-toggle" href="javascript:ovid(0)"><i class="icon-bell-alt"></i><span class="badge badge-important">8</span>&nbsp</a>
					...
					<ul class="nav nav-list" id="nav_list">
                     ...
                     <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 产品管理 </span><b class="arrow icon-angle-down"></b></a>
					   <ul class="submenu">
						 ...
						 <!-- <li class="home"><a  href="javascript:void(0)" name="pagetest.jsp"  title="分页联系" class="iframeurl"><i class="icon-double-angle-right"></i>分页练习</a></li> -->
