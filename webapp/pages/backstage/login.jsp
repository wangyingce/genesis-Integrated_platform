...
<div class="login-container">
   ...
   <li class="frame_style form_error"><label class="password_icon"></label><input name="密码" type="password"   id="userpwd"/><i>密码</i></li>   
                        ...
                        <div class="loginbm">版权所有  2016  <a href="">GENESIS系统有限公司</a> </div><strong></strong>
</body>
</html>
<script>
          ...
          $.ajax({
                   ...
                   data: {
                      ...
                      success: function(data) {
                           if(data=="0"){
                             layer.alert('用户名或者密码错误！',{title: '提示框',icon:1,});
                           }else if(data=="1"){
                             layer.alert('登陆成功！',{title: '提示框',icon:1,});
	                         location.href="index.jsp";
                             //window.location.href='/login/checkPower.do';
			                 layer.close(index);
                           }
                      }
            });
