   ...
   <div class="type_title">添加商品</div>
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class=" clearfix cl">
			...
			<div class="formControls col-2"><input type="text" ng-model = "p.productNum" class="input-text" value="" placeholder="" id="productNum" name="productNum"></div>
            </div>
			<div class="Add_p_s">
             <label class="form-label col-2">产&nbsp;&nbsp;&nbsp;&nbsp;地：</label>	
			 <div class="formControls col-2"><input type="text" ng-model = "p.country" class="input-text" value="" placeholder="" id="country" name="country"></div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2">材&nbsp;&nbsp;&nbsp;&nbsp;质：</label>	
			 <div class="formControls col-2"><input type="text" ng-model = "p.material" class="input-text" value="" placeholder="" id="material" name="material"></div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2">数&nbsp;&nbsp;&nbsp;&nbsp;量：</label>	
			 <div class="formControls col-2"><input type="text" ng-model = "p.count" class="input-text" value="" placeholder="" id="count" name="count"></div>
			</div>
             <div class="Add_p_s">
             <label class="form-label col-2">产品重量：</label>	
			 <div class="formControls col-2"><input type="text" ng-model = "p.weight" class="input-text" value="" placeholder="" id="weight" name="weight" >kg</div>
			</div>
             <div class="Add_p_s">
             <label class="form-label col-2">单位：</label>	
			 <div class="formControls col-2"><span class="select-box">
				<select class="select" id="unit" ng-model = "p.unit">
					<option>请选择</option>
            ...
            <div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" ng-model = "p.showPrice" class="input-text" value="" placeholder="" id="showPrice" name="showPrice" >元</div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2">市场价格：</label>	
			 <div class="formControls col-2"><input type="text" ng-model = "p.marketPrice" class="input-text" value="" placeholder="" id="marketPrice" name="marketPrice" >元</div>
			</div>
